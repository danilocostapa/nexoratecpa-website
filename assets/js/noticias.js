...
const API_KEY = '5e8543eaed144748b72c29a391942e8a'; // chave da NewsAPI
const container = document.getElementById('noticias-internacionais');

fetch(`https://newsapi.org/v2/top-headlines?country=br&pageSize=4`, {
    ...
    .then(data => {
        if (data.status === 'ok' && data.articles.length > 0) {
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://api.whatsapp.com/send?text=${encodeURIComponent(noticia.title + ' ' + noticia.url)}" target="_blank" class="btn btn-success mt-2 ms-2">
            ...
            container.innerHTML = '<p>Não foi possível carregar as notícias no momento.</p>';
        }
    })
    .catch(err => {
